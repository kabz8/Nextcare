    ...
    <CardContent className="px-6 py-8">
      <div className="text-center">
        ...
        <div className="bg-neutral-50 rounded-lg p-6 mb-6 text-left">
          ...
          <p className="mb-2"><strong>Location:</strong> Village Dental - CO</p>
        ...
        <p className="text-sm text-neutral-500">Need to make changes? Please call our office at (555) 123-4567</p>
      </div>
    </CardContent>
  );
}
